...
public class MessageTransferService extends IntentService {
     ...
     */
    @Override
    protected void onHandleIntent(Intent intent) { // todo send message there
        ...
        if (intent.getAction().equals(ACTION_SEND_FILE)) {
            ...
            try {
                Log.d("MessageTransferService", "Opening client socket - ");
                socket.bind(null);
                ...
                try {
                    ...
                    Log.d("MessageTransferService", e.toString());
                }
